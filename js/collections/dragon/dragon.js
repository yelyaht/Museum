...
(() => {
  ...
  // Bind to this page's side-column images (and also card images if present)
  const imgs = document.querySelectorAll('.dragon-side-column img, .card-image img');
  imgs.forEach(img => {
    ...
    img.addEventListener('click', () => {
      ...
      // Prefer nearby heading for caption; fall back to alt
